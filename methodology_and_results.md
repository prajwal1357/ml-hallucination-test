...
![Cross-Model Behavior Distribution by Domain](enhanced_plots/cross_model_behavior.png)

**Figure 2: Context Adherence Rate (CAR) Trend Across Domains**
![Context Adherence Rate (CAR) Across Domains](enhanced_plots/car_line_comparison.png)
...
![Classifier Performance Comparison](enhanced_plots/classifier_comparison.png)
...
![Random Forest Feature Importance Heatmap](enhanced_plots/rf_feature_heatmap.png)

**Figure 5: Feature Importance Radar Chart**
![Feature Importance Radar](enhanced_plots/feature_radar.png)

**Figure 6: Average Feature Importance Across All Models**
![Average Feature Importance](enhanced_plots/avg_feature_importance.png)
...
![Gradient Boosting Feature Importance Heatmap](enhanced_plots/gb_feature_heatmap.png)
...
![Logistic Regression Coefficients Heatmap](enhanced_plots/lr_coefficients_heatmap.png)

---

## 4.3 Diagnostic Visualizations

All visualization charts are generated by [generate_visualizations.py](generate_visualizations.py) and saved to the `enhanced_plots/` directory. Below is the full list of generated figures:

### Enhanced Analysis Charts (New)

| Figure   | Description                                       | File Path                                                                                                    |
| :------- | :------------------------------------------------ | :----------------------------------------------------------------------------------------------------------- |
| Figure 1 | Cross-Model Behavior Distribution by Domain       | [cross_model_behavior.png](enhanced_plots/cross_model_behavior.png)       |
| Figure 2 | Context Adherence Rate (CAR) Trend Across Domains | [car_line_comparison.png](enhanced_plots/car_line_comparison.png)         |
| Figure 3 | Classifier Performance Comparison (Accuracy & F1) | [classifier_comparison.png](enhanced_plots/classifier_comparison.png)     |
| Figure 4 | Random Forest Feature Importance Heatmap          | [rf_feature_heatmap.png](enhanced_plots/rf_feature_heatmap.png)           |
| Figure 5 | Feature Importance Radar Chart                    | [feature_radar.png](enhanced_plots/feature_radar.png)                     |
| Figure 6 | Average Feature Importance Bar Chart              | [avg_feature_importance.png](enhanced_plots/avg_feature_importance.png)   |
| Figure 7 | Gradient Boosting Feature Importance Heatmap      | [gb_feature_heatmap.png](enhanced_plots/gb_feature_heatmap.png)           |
| Figure 8 | Logistic Regression Coefficients Heatmap          | [lr_coefficients_heatmap.png](enhanced_plots/lr_coefficients_heatmap.png) |

### Per-Model Behavior Charts (Original Pipeline)

| Model            | Behavior Distribution                                                                              | Feature Importance                                                                           |
| :--------------- | :------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------- |
| DeepSeek-R1 (8B) | [behavior_distribution.png](deepseek/behavior_distribution.png) | [feature_importance.png](deepseek/feature_importance.png) |
| Llama-3 (8B)     | [behavior_distribution.png](llama3/behavior_distribution.png)   | [feature_importance.png](llama3/feature_importance.png)   |
| Mistral (7B)     | [behavior_distribution.png](mistral/behavior_distribution.png)  | [feature_importance.png](mistral/feature_importance.png)  |
