...
1.  The new features (**Flesch-Kincaid grade**, **Perturbation position**, **Numeric density**) collectively contribute **~35% of total importance** across all models, demonstrating that they capture meaningful signal that the original 3-feature model could not.
...
To review or insert the generated charts into your manuscript, open the absolute image paths on your system:

### A. DeepSeek-R1 (8B) Charts
*   **Behavior Distribution (CAR vs. PRR vs. ODR)**:
    [deepseek/behavior_distribution.png](file:///P:/project/research/dataset/deepseek/behavior_distribution.png)
*   **ML Feature Importance Chart**:
    [deepseek/feature_importance.png](file:///P:/project/research/dataset/deepseek/feature_importance.png)

### B. Llama-3 (8B) Charts
*   **Behavior Distribution (CAR vs. PRR vs. ODR)**:
    [llama3/behavior_distribution.png](file:///P:/project/research/dataset/llama3/behavior_distribution.png)
*   **ML Feature Importance Chart**:
    [llama3/feature_importance.png](file:///P:/project/research/dataset/llama3/feature_importance.png)

### C. Mistral (7B) Charts
*   **Behavior Distribution (CAR vs. PRR vs. ODR)**:
    [mistral/behavior_distribution.png](file:///P:/project/research/dataset/mistral/behavior_distribution.png)
*   **ML Feature Importance Chart**:
    [mistral/feature_importance.png](file:///P:/project/research/dataset/mistral/feature_importance.png)
